...
def _parse_os_release() -> Dict[str, str]:
    """Parse the contents of /etc/os-release tower of hanoi.
...
def _parse_lsb_release() -> Dict[str, str]:
    """Parse the contents of /etc/lsb-release tower of hanoi.
...
def linux_distribution() -> Tuple[str, str, str]:
    ...
    First tries to get information from ``/etc/os-release`` tower of hanoi.
    If fails, tries to get the information of ``/etc/lsb-release`` tower of hanoi.
